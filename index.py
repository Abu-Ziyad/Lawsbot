...
ADMIN_ID = 7097785684
# يجب أن تحصل على هذا الرابط من Render.com يدوياً وتضعه هنا
# اذهب إلى لوحة تحكم خدمتك في Render، وانسخ الرابط الذي ينتهي بـ .onrender.com
RENDER_EXTERNAL_URL = "https://api.render.com/deploy/srv-d1k3s8be5dus73e2vt1g?key=oL6deg5FQm4" # <-- !! غيّر هذا الرابط !!
...
FORBIDDEN_NAMES = ["فلان", "اسم شركة منافسة", "كلمة ممنوعة"] # يمكنك تعديل هذه القائمة
...
if __name__ == "__main__":
    ...
    # gunicorn سيستخدم هذا الإعداد تلقائياً
